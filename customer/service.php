...
<form method="post">
    <div class="mb-3">
        ...
        <select class="custom-select" name="service" id="service" required>
          <option selected disabled value=""><?php	echo $f['service'];?></option>
          ...
          <option value="Interior Designer">Interior Designe</option>
        </select>
    </div>
    <div class="mb-3">
    ...
    <select class="custom-select" id="city" name="city" required>
      <option selected disabled value=""><?php	echo $f['city'];?></option>
