...
$link = $email;
    ...
    try {
        ...
        $mail->Body    = 'This is link <a href="http://localhost/provider/setpassword.php">Click here</a> for set password where you can paste email and token the ste password . '.$email. ' this is token number is = ' .$token.'';
...
$token=md5(rand());
	...
	$s= "select * from provider where email='$e'";
    ...
    $update_token = "update provider set token='$token' where email='$email'";
...
<div class="form-container">
   ...
   <form method="POST" enctype="multipart/form-data">
      ...
      <p>don't have an account? <a href="pro_register.php">register now</a></p>
   </form>
